...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Assert.AreEqual. Expected <Bob>, but is <Sue>. Probably is an error in the order of the queue
    ...
    // Defect(s) Found: Assert.AreEqual. Expected <Bob>, but is <Sue>.
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: The infinity turns condition is not there
    ...
    // Defect(s) Found: Condition for numbers less than cero is not in the code
