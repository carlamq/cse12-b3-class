public class SimpleQueue {
    public static void Run() {
        ...
        // Defect(s) Found: Removing data from index 1 no from 0
        ...
        value = queue.Dequeue();
        Console.WriteLine(value);
        // Defect(s) Found: The value was inserted in the front
    ...
    private void Enqueue(int value) {
        _queue.Add(value); //need add the value at the end, not from cero
    }
